    ...
    <header class="delimiter max-w-screen-xl md:h-[100vh] py-[100px] md:py-[0px]">
        <div class="flex items-center h-full">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
                <div>
                    <h1><strong>Scale</strong> your product. <strong><i>Accelerate</i></strong> Software Development</h1>
            ...
            <div class="owl-carousel owl-theme">
                <div class="item">
                    <div class="text-white text-center bg-gradient-to-b from-[#6A71B5] to-[#646BAC] rounded-[50px] relative px-5 pb-[40px] pt-[120px]">
                        ...
                        <p class="pb-5">Some clients that we developed products for expanded into new markets with measurable success. Let's get you on that list.</p>
...
<section class="bg-[#DEE1FF]">
    <div class="delimiter pt-[100px] pb-[100px] md:pb-[150px]">
        <div class="text-center">
            <span class="text-[14px] font-bold bg-[#6A71B5] py-2 px-10 rounded-full text-white">Our Services</span>
            <h2 class="mt-6 mb-3"><b class="font-bold text-[#41477B] text-[40px] leading-8 ">Ready to Start with Native Productions?</b></h2>
            <p>Some clients that we developed products for expanded into new markets with measurable success. Let's get you on that list.</p>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-14 items-start pt-[100px]">
            <div class="bg-white shadow rounded-[50px] py-[50px]">
                <div class="text-center border-b border-1 pb-5">
                    <h3 class="text-[24px] font-bold text-[#41477B]">Personal</h3>
                    <div class="flex gap-4 justify-center items-center py-4">
                        <s>Rp1.000.000</s>
                        <span class="text-[14px] font-bold bg-[#DEE1FF] px-2 py-1 rounded-full text-[#6A71B5]">Disc 20%</span>
                    </div>
                    ...
                    <p class="pt-4">Lorem Ipsum Dolor Sit Amet</p>
                </div>
                <div class="px-5 py-3">
                    ...
                    <div class="divide-y divide-slate-200">
                        ...
                        <div x-data="{ expanded: false }" class="py-2">
                            <h2>
                                <button id="faqs-title-01" type="button" class="flex items-center justify-center gap-3 text-[#6A71B5] text-[16px] w-full text-left font-semibold py-2" @click="expanded = !expanded" :aria-expanded="expanded" aria-controls="faqs-text-01">
